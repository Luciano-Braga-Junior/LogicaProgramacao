programa
{
	...
	funcao retorno_calculo_adicional_ferias()
	{
		...
		escreva("Digite qual o valor do seu salário bruto: ")
		...
		escreva("\nO colaborador receberá a mais R$ ", adicional_ferias)
	...
	funcao real calculo_adicional_ferias(real calculo_adicional_ferias_var_salario_bruto)
	{
		...
		real desconto_1, desconto_2, desconto_3, desconto_4, calculo_desconto_inss_var_salario_bruto
		...
		se(calculo_adicional_ferias_var_salario_bruto < 2826.66)
		{
			ir = (calculo_adicional_ferias_var_salario_bruto) * 0.075
		}
		senao se(calculo_adicional_ferias_var_salario_bruto < 3751.06)
		{
			ir = (calculo_adicional_ferias_var_salario_bruto) * 0.15
		}
		senao se(calculo_adicional_ferias_var_salario_bruto < 4664.69)
		{
			ir = (calculo_adicional_ferias_var_salario_bruto) * 0.225
		}
		senao
		{
			ir = (calculo_adicional_ferias_var_salario_bruto) * 0.275
		}
	...
	funcao real calculo_adicional_noturno(real calculo_adicional_noturno_var_salario_bruto)
	{
		...
		valor_adicional_noturno = ( calculo_adicional_noturno_var_salario_bruto * 0.2) * 0.0
		salario_descontado = (calculo_adicional_noturno_var_salario_bruto) + valor_adicional_noturno
	...
	funcao retorno_calculo_adicional_horas_extras()
	{
		...
		escreva("Digite quantas horas extras trabalhadas: ")
	...
	funcao real calculo_adicional_horas_extras(real calculo_adicional_horas_extras_var_salario_bruto)
	{
		...
		valor_adicional_horas_extras = (calculo_adicional_horas_extras_var_salario_bruto * 1.5) * calculo_adicional_horas_extras_var_salario_bruto
 ...
 * 
 * @POSICAO-CURSOR = 10332; 
 * @DOBRAMENTO-CODIGO = [25, 34, 54, 82, 148, 171, 264, 290, 393, 415, 422, 441, 452, 493, 545, 555, 587, 611, 620, 652, 676, 684, 772, 836];
 * @PONTOS-DE-PARADA = ;
